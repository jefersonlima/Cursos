...
A função reversed() retorna um interável chamado List Reverse Interator
"""
...
#  Podemos iterar sobre o reserved
...
#  Podemos também utilizat o reversed() para fazer um loop for reverso
