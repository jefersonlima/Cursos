...
#  Correto annotation em variavéis com atribuição de valores
alinhamento: bool = True

#  Incorreto annotation em variavéis com atribuição de valores
alinhamento:bool=True
alinhamento : bool = True
alinhamento : bool=True
alinhamento: bool= True
...
# print(ativo)
#
# print(__annotations__)  #  mostra a annotation de todas variáveis globais
...
#  print(p.__init__.annotations__)  #  AttributeError
