...
"""
Novas Funções em Python versão 3.8
...
# statistics.fmean - calcula a média de múmeros reais
...
# statisticsgeometric_mean - calcula a média geométrica de números reais

# print(statistics.geometric_mean(valores_reais))
# print(statistics.geometric_mean(valores_inteiros))

# statisitcs.multimode - retorna o valor mais frequente em uma sequencia
