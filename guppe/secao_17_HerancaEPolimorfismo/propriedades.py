...
Em linguagens de programação como o Java, ao declaramos atributos privados nas classes, costumamos a criar métodos
...
#  É possivel criar métodos do tipo property
    @property
