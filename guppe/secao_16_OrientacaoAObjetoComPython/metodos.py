...
OBS: Todo método/funções dunder em Python são chamados de métodos mágicos.

ATENÇÃO! Por mais que pssamos criar nossas próprias funções utilizando dunder (underline no ínicio e no fim)
...
user2 = Usuario('Felity', 'Jones', 'felicity@gmail.com', '654321')
