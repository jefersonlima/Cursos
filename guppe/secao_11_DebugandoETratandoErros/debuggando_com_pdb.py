...
#  Exemplo com o PDB 2 - Python Debugger
...
#  no ínicio do arquivo. Por isso, ao invés de colocarmos o import do pdb no ínicio do arquivo.
#  nós colocamos somente onde vamos debuggar, e ao finalizar já fazemos a remoção.

#  Exemplo com o PDB 3 breakpoint - Python Debugger
...
#  Como os nomes das variavéis são os mesmos dos comandos do pdv, devemos utilizat o cimando p para imprimir
